import type { filterParams, PaginationCursorParams } from "./pagination-cursor.js";

export function parsePaginationQuery(query : Record<string, any>): PaginationCursorParams {
        return {
